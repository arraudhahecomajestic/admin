...
export default async function KhairatPage({
  ...
  return (
    <div className="space-y-6">
      <AdminNav aktif="/admin/khairat" nama={profil.nama ?? profil.emel ?? undefined} />
              ...
              {keahlian.map((k) => {
                ...
                return (
                  <tr key={k.id} className="border-b last:border-0">
                    ...
                    <td className="px-4 py-2">{lunas ? <span className="text-green-600">Lunas</span> : <span className="text-red-600">Belum</span>}</td>
                    <td className="px-4 py-2">
                      {lunas ? (

-- ============================================================
-- e-Surau · Skema Fasa 19 (Wajibkan swafoto + e-tandatangan masa DAFTAR)
-- Menambah semakan server-side supaya pendaftaran TANPA selfie / e-sign ditolak,
-- walaupun semakan di pelayar diakali.
-- Jalankan SELEPAS fasa 12.
-- ============================================================
...
begin
  ...
  v_esign := true;  -- kedua-dua sudah disahkan wujud di atas

-- ============================================================
-- e-Surau · Skema Fasa 11 (Gelaran ahli)
-- Jalankan SELEPAS fasa 1-10.
-- ============================================================

alter table ahli_kariah add column if not exists gelaran text;

-- Kemas kini RPC pendaftaran supaya simpan gelaran juga.
